...
public class ExcelFileUtil{
	...
	{
	FileInputStream fi=new FileInputStream("E:\\Srikanth_82\\StocKAccounting_DDF\\TestInput\\supplier.xlsx");
	...
	public void SetCellData(String Sname,int row,int coloumn,String Status) throws Exception
	{
		...
		FileOutputStream fo=new FileOutputStream("E:\\Srikanth_82\\StocKAccounting_DDF\\TestOutput\\supplier.xlsx");
		wb.write(fo);
		fo.close();
